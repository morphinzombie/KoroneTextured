...
"version-cde8fee1a1e747d4" folder,
and replace the files.

## Bugs/Incomplete

If something is broken or incomplete, message me on discord (@morphinzombie) with what is broken/incomplete.

I will be adding 2017L & 2018L clients later on, so check back soon for a newer release.
